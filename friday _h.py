...
def main():
  ...
  if not is_connected:
    ...
    "text-align:center;\n "                                                                                                                         
            ...
            string=' '*7
            self.plainTextEdit1.insertPlainText(f"\t {string}|{string}Harpreet Singh\t|\n")
            self.plainTextEdit1.insertPlainText("\nPython Developer\n")
            self.plainTextEdit1.insertPlainText("\nRole in Project: Project design & GUI\n")
            self.plainTextEdit1.insertPlainText("\nE-mail: singhharrypreet298@gmail.com")
    ...
    "text-align:center;\n "                                                                                                                         
            ...
            self.plainTextEdit2.insertPlainText("\t  |\Virotam \t|\n")
            self.plainTextEdit2.insertPlainText("\nPython Developer\n")
            self.plainTextEdit2.insertPlainText("\nRole in project: Scripting and Logic\n")            
            self.plainTextEdit2.insertPlainText("\nE-mail: virotampalkaurgmail.com")
    ...
    ##                         os.system("start ms-windows-camera:")
                         ...
                         if 'your developers' in query or 'who created you' in query or 'who designed you' in query or 'who built you' in query or 'developers' in query or 'developer' in query:
                             speak("i was created by mr. Harpreet Singh and Miss Virotam a ")
                             Ui.terminalPrint("i was created by mr. Harpreet Singh and Miss Virotam  ")
